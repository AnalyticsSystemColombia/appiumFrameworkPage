...
public class appiumUtilidades 
{
	...
	public List<HashMap<String, String>> getJsonData(String jsonFilePath) throws IOException {
		...
		//String jsonContent = FileUtils.readFileToString(new File(System.getProperty("user.dir")+"//src/test/java/testData/pageMain.json"),StandardCharsets.UTF_8);
		//System.getProperty("user.dir")+"//src/test/java/testData/pageMain.json
